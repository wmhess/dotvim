" Kali - A test colorscheme based on Kellys - the info is below
" Todo - Update this info once I get this to a stable form.
...
if has("gui_running")
	...
	hi Cursor 		guifg=#2a2b2f	guibg=#F0E591	gui=none
	...
	hi Search		guifg=#F0F8F0	guibg=#CB8546	gui=none
	...
	hi Type 		guifg=#E8BF64	guibg=#2a2b2f	gui=none
	hi Underlined	guifg=#e1e0e5	guibg=#2a2b2f	gui=underline
	hi Visual		guifg=#F0F8FF	guibg=#5A647E	gui=none
